...
class LivestreamStudio:
   ...
   def ParseVerses(self, keyValues, language):
      ...
      for x in keyValues:
         ...
         print "Length: {}".format(innerListlength)
         PressEnterToContinue()
         holdvalue_counter = 0
         loopCounter = 0
         loopIterator = 0
      ...
      print "[+] Done -> {}".format(self.testWrite)
      # raw_input("Enter To Continue")
      print "[+] Ready To Send Write Command To Computer"
      PressEnterToContinue()
      self.writeFiles()
   ...
   def checkSpecialCharacters(self, verse, initialFalseValue=False):
      ...
      #    if "\xc2\xa0" in verse:
      #       verse = self.swapUnicodeToString(verse)
      #       setUnicodeEncoding()
      #       verse = verse.replace("    ", " ")
      #       if "   " in verse:
      #          verse = verse.replace("   ", " ")
      #    else:
      #       try:
      #          print "No Spaces Found: {}".format(verse)
      #       except UnicodeEncodeError:
      #          print "[=] UnicodeEncodeError: unicode check ({})".format(u'\xa0' in verse)
      #       PressEnterToContinue()
